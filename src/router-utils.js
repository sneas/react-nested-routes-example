...
export const setupParents = (routes, parent = null) => routes.map(route => {
    const withParent = {
        ...route,
        ...parent && { parent }
    };
    ...
    return {
        ...withParent,
        ...withParent.children && { children: setupParents(withParent.children, withParent) },
    };
});
...
export const flattenParents = route => {
    ...
    return [
        route.parent,
        ...flattenParents(route.parent)
    ].flat(Infinity);
};


export const flattenRoutes = routes => routes.map(route => ([
    route,
